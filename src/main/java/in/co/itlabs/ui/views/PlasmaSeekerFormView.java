...
@Route(value = "plasma-seeker-form", layout = GuestLayout.class)
@CssImport("./styles/shared-styles.css")
public class PlasmaSeekerFormView extends VerticalLayout implements BeforeEnterObserver {
